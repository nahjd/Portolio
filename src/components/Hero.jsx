    ...
    return (
        <div className="h-screen flex items-center justify-center flex-col lg:flex-row  from-blue-500 to-purple-500">
            <div className="w-full lg:w-1/2 flex items-center justify-center flex-col text-center">
                <h3 className="text-white text-2xl lg:text-4xl mb-2 flex items-center justify-center gap-2"> <br />
                    Hii I'M
                    <img
                ...
                <span className="text-[#ad50eb] text-2xl lg:text-3xl font-semibold  h-20 lg:h-32 w-72 lg:w-80 flex items-center justify-center px-5 rounded-md shadow-xl capitalize">
                    <Type />
                </span>
            </div>
        </div>
